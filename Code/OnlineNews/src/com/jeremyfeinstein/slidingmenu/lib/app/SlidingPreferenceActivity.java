...
public abstract class SlidingPreferenceActivity extends PreferenceActivity implements SlidingActivityBase {
	...
	public void setContentView(View v) {
		setContentView(v, new LayoutParams());
	}
	...
	public void setBehindContentView(View v) {
		setBehindContentView(v, new LayoutParams());
	}
